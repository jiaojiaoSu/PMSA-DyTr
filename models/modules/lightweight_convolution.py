...
from models.modules.unfold import unfold1d


def LightweightConv(input_size, kernel_size=1, padding_l=None, num_heads=1,
                    weight_dropout=0., weight_softmax=False, bias=False, with_linear=False, out_dim=None):
    if torch.cuda.is_available():
        try:
            ...
            return LightconvLayer(input_size, kernel_size=kernel_size,
                                  ...
                                  with_linear=with_linear, out_dim=out_dim)
