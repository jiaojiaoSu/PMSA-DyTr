...
class FastDETR(nn.Module):
    ...
    def __init__(self, args, backbone, transformer, num_classes):
        ...
        self.num_feature_levels = 4 if self.multiscale else 1          # Hard-coded multiscale parameters#MODIFY BY SJJ
...
def build(args):
    ...
    num_classes = 20 if args.dataset_file != 'coco' else 7#91->7 for NEU, the num_classes==7
