...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='output/checkpoint0149.pth', help='resume from checkpoint, empty for training from scratch')#结果可视化的模型
...
def main(args):
    ...
    inference_dir = "NEU_test/"
    inference_dir1 = "NEU_out/"
